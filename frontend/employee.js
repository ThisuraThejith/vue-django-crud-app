    ...
    <table class = "table table-striped">
        ...
        <tbody>
            <tr v-for="emp in employees">
                ...
                <td>
                    <button type="button"
                    class="btn btn-light mr-1" data-bs-toggle="modal" data-bs-target="#exampleModal"
                    @click="editClick(emp)">
                    ...
                    <button type="button"
                    class="btn btn-light mr-1" @click="deleteClick(emp.EmployeeId)">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button type="button" v-if="EmployeeId==0" class="btn btn-primary"
